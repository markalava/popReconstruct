...
#' P. (2013). \dQuote{Reconstructing Past Populations With Uncertainty From
#' Fragmentary Data.} \emph{Journal of the American Statistical Association},
#' 108(501), 96--110. \url{https://doi.org/10.1080/01621459.2012.737729}
#'
#' Wheldon, M. C., Raftery, A. E., Clark, S. J., & Gerland,
#' P. (2015). \dQuote{Bayesian Reconstruction of Two-Sex Populations by Age:
#' Estimating Sex Ratios at Birth and Sex Ratios of Mortality.} \emph{Journal
#' of the Royal Statistical Society: Series A (Statistics in Society)},
#' 178(4), 977--1007. \url{https://doi.org/10.1111/rssa.12104}
#'
#' Wheldon, M. C., Raftery, A. E., Clark, S. J., & Gerland,
#' P. (2016). \dQuote{Bayesian population reconstruction of female
#' populations for less developed and more developed countries.}
#' \emph{Population Studies}, 70(1),
#' 21--37. \url{https://doi.org/10.1080/00324728.2016.1139164}
NULL
